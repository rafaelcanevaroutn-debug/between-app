    ...
    <section id="contacto" className="relative py-32 overflow-hidden dot-grid">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          {/* Key Points */}
          <div className="flex flex-col gap-5 max-w-xl mx-auto mb-16 text-left">
            {[
              "Vas a salir con claridad sobre qué estás comunicando hoy.",
              "Qué te falta para que se entienda mejor.",
              "Y cómo convertir lo que ya hacés en una serie."
            ].map((text, i) => (
              <div key={i} className="flex items-center gap-4 group">
                <div className="w-2 h-2 rounded-full bg-cyan shadow-[0_0_8px_rgba(0,196,204,0.6)]" />
                <p className="text-white/70 text-base md:text-lg group-hover:text-white transition-colors">
                  {text}
                </p>
              </div>
            ))}
